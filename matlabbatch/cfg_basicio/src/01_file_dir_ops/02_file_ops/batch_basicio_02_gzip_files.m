%-----------------------------------------------------------------------
% Job saved on 25-Sep-2013 15:20:44 by cfg_util (rev $Rev: 5685 $)
% spm SPM - SPM12b (beta)
...
matlabbatch{2}.menu_cfg.menu_struct.conf_exbranch.name = 'GZip Files';
matlabbatch{2}.menu_cfg.menu_struct.conf_exbranch.tag = 'cfg_gzip_files';
...
matlabbatch{2}.menu_cfg.menu_struct.conf_exbranch.prog = @(job)gzip(job.files);
matlabbatch{2}.menu_cfg.menu_struct.conf_exbranch.vout = @cfg_vout_gzip_files;
matlabbatch{2}.menu_cfg.menu_struct.conf_exbranch.check = [];
matlabbatch{2}.menu_cfg.menu_struct.conf_exbranch.help = {'GZip each file in a set of files.'};
