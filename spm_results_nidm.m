...
p.entity(idData,{...
    ...
    'prov:type',nidm_conv('nidm_DataScaling',p),...
...
if isfield(SPM.xVi,'form')
    if strcmp(SPM.xVi.form,'i.i.d')
        ...
        extra_fields_PE = {
            nidm_conv('nidm_withEstimationMethod',p),nidm_conv('stato_OLS',p),...
            };
    else
        extra_fields_NM = {...
            nidm_conv('nidm_hasErrorDependence',p),nidm_conv('stato_ToeplitzCovarianceStructure',p),...
...
for i=1:numel(SPM.Vbeta)
    ...
    id = originalfile(p,SPM.Vbeta(i).fname,idBeta{i},nidm_conv('nidm_ParameterEstimateMap',p));
...
for c=1:numel(xSPM.Ic)
    ...
    p.entity(idConVec,{...
        'prov:type',nidm_conv('stato_ContrastWeightMatrix',p),...
        nidm_conv('nidm_statisticType',p),nidm_conv(['stato_' xSPM.STAT 'Statistic'],p),...
...
thresh(3).type  = nidm_conv('obo_pValueFWER',p);
...
p.entity(idExtentThresh2,{...
    'prov:type',nidm_conv('nidm_ExtentThreshold',p),...
    'prov:type',nidm_conv('obo_pValueFWER',p),...
...
if ~isempty(i)
    ...
    if nargin == 2
        ...
        switch prefix
            ...
            case 'neurolex'
                url = 'http://neurolex.org/wiki/';
            otherwise
                warning('Problem with prefix.');
                url = '';
        end
...
C = {...
'afni:GammaHRF', 'afni_AFNIsGammaHRF';...
'afni:LegendrePolynomialDriftModel', 'afni_AFNIsLegendrePolinomialDriftModel';...
...
'nidm:NIDM_0000003', 'nidm_ArbitrarilyCorrelatedError';...
'nidm:NIDM_0000004', 'nidm_BinaryMap';...
'nidm:NIDM_0000005', 'nidm_BinomialDistribution';...
'nidm:NIDM_0000006', 'nidm_Cluster';...
...
'nidm:NIDM_0000010', 'nidm_hasfMRIDesign';...
...
'nidm:NIDM_0000032', 'nidm_GaussianDistribution';...
...
'nidm:NIDM_0000058', 'nidm_NonParametricDistribution';...
...
'nidm:NIDM_0000065', 'nidm_PoissonDistribution';...
...
'nidm:NIDM_0000095', 'nidm_partialConjunctionDegree';...
...
'nidm:NIDM_0000125', 'nidm_userSpecifiedThresholdType';...
...
'nidm:NIDM_0000152', 'nidm_BlockBasedDesign';...
'nidm:NIDM_0000153', 'nidm_EventRelatedDesign';...
'nidm:NIDM_0000154', 'nidm_MixedDesign';...
'nidm:NIDM_0000155', 'nidm_fMRIDesignType';...
...
'spm:SPM_0000007', 'spm_noiseFWHMInUnits';...
'spm:SPM_0000008', 'spm_noiseFWHMInVertices';...
'spm:SPM_0000009', 'spm_noiseFWHMInVoxels';...
'spm:SPM_0000010', 'spm_searchVolumeReselsGeometry';...
'spm:SPM_0000011', 'spm_smallestSupraThresholdClusterSizeInVerticesFDR05';...
'spm:SPM_0000012', 'spm_smallestSupraThresholdClusterSizeInVerticesFWE05';...
'spm:SPM_0000013', 'spm_smallestSupraThresholdClusterSizeInVoxelsFDR05';...
'spm:SPM_0000014', 'spm_smallestSupraThresholdClusterSizeInVoxelsFWE05';...
'spm:SPM_0000015', 'spm_partialConjunctionDegree';...
};

C = [C; {...
'neurolex:nif-0000-00343', 'neurolex_SPM';...
'obo:STATO_0000039', 'obo_Statistic';...
'obo:OBI_0001265', 'obo_pValueFWER';...
'obo:OBI_0001442', 'obo_qValueFDR';...
